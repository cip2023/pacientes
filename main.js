...
function drawFechasList(){
    ...
    for(var i = 0; i < list.length; i++){
        ...
        for(var r = 0; r < list[i].visitasList.length; r++){
            ...
            if(new Date(laños,lmeses,ldias) > new Date(fechahoy.getFullYear(), (fechahoy.getMonth() + 1), fechahoy.getDate()) && new Date(laños,lmeses,ldias) <=  new Date(fechahoy.getFullYear(), (fechahoy.getMonth() + 1), (fechahoy.getDate() + 14))  ){
